...
Energian errore sistematikoa desagertzeko, inplementazio estandarrean honako aldaketak proposatu zituen:
\begin{enumerate}
...
\begin{tabular}{c c}
\subfloat[NCDP ($h=2^{-7}$)]
{\includegraphics[width=.600\textwidth]{NCDP1A}}\\
\subfloat[OSS ($h=500/3$)]
{\includegraphics[width=.600\textwidth]{NBODY1A}}
\end{tabular}
...
\begin{tabular}{c c}
\subfloat[\small {NCDP}]
{\includegraphics[width=.4\textwidth]{NCDP2B}} %Fig6
&
\subfloat[OSS]
{\includegraphics[width=.4\textwidth]{NBODY2B}} %Fig7
\\
