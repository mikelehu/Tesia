...
\begin{figure} [h!]
\centerline{\includegraphics [width=14cm, height=5cm] {proiekzioa1}}
...
\subsubsection*{Eszentrikotasun eta sasi-ardatzaren errore estimazioak}
...
\subfloat[ABAH1064 (sasi-ardatzaren errorea)]
...
Hirugarren esperimentu honetan, biribiltze errorearen azterketa egin dugu eta horretarako, momentu angeluarraren errore erlatiboaren eboluzioan oinarritu gara. Momentu angeluarraren trunkatze errorea beti zero da eta metodo sinplektikoek inbariante koadratikoak zehazki mantentzen dituzte. \ref{fig:esp85}~irudian, Gaussen $s=8$ ataletako metodoarekin, $h=9.0$ eta $h=10.63$ urrats luzerarekin integrazioen soluzioen momentu angeluarraren errorea erakutsi dugu.  
